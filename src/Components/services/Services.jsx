  ...
  return (
    <div className="services" id="services">
      <div className="s-services">
        ...
        <h2>what service can you expect from me?</h2>
      </div>
        ...
        <motion.div    transition={transition} whileHover={{scale:1.05 }}>
          ...
          <Card className="cardshadow"  style={{ width: "18rem"}}>
            <Card.Body>
              ...
              <Card.Title  className="s-cardt ">Front-End UI/UX</Card.Title>
              <Card.Text  >
        ...
        <motion.div  transition={transition} whileHover={{scale:1.05 }}>
          <Card className="cardshadow"   style={{ width: "18rem" }}>
            <Card.Body>
              ...
              <Card.Title className="s-cardt">Web Development</Card.Title>
              <Card.Text>
        ...
        <motion.div  transition={transition} whileHover={{scale:1.05 }}>
          <Card className="cardshadow" style={{ width: "18rem" }}>
            <Card.Body>
              ...
              <Card.Title className="s-cardt">Figma Designing</Card.Title>
              <Card.Text>
              I love to develop a dynamic, eye-catching, top-notch and pixel-perfect designs for web-pages.
              </Card.Text>
            </Card.Body>
          </Card>
        </motion.div>
        ...
        <motion.div  transition={transition} whileHover={{scale:1.05 }}>
          <Card className="cardshadow"  style={{ width: "18rem" }}>
            <Card.Body>
              ...
              <Card.Text>
              Websites with Customization perfectly meets client's web design requirements.
              </Card.Text>
            </Card.Body>
          </Card>
        </motion.div>
